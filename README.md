...
Main script is Slaime.lua (may have some bug but will always be the latest version)

Stable script is Slaime_old.lua (this one is a version that worked well in the past)
